...
/// <summary>
/// Validator cho CreateUserServiceRequest.
/// </summary>
public class CreateUserServiceRequestValidator : AbstractValidator<CreateUserServiceRequest>
{
    public CreateUserServiceRequestValidator()
    {
