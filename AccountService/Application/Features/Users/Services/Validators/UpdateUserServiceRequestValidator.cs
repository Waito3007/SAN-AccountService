...
/// <summary>
/// Validator cho UpdateUserServiceRequest.
/// </summary>
public class UpdateUserServiceRequestValidator : AbstractValidator<UpdateUserServiceRequest>
{
    public UpdateUserServiceRequestValidator()
    {
        RuleFor(x => x.UserId)
